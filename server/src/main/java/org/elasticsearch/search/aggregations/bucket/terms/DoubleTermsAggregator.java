...
public class DoubleTermsAggregator extends LongTermsAggregator {
    ...
    private static DoubleTerms convertToDouble(LongTerms terms) {
        ...
        return new DoubleTerms(terms.getName(), terms.order, terms.requiredStart, terms.requiredSize, terms.minDocCount, terms.pipelineAggregators(),
                terms.getMetaData(), terms.format, terms.shardSize, terms.showTermDocCountError, terms.otherDocCount, terms.bucketCount, buckets,
                terms.docCountError);
    }
